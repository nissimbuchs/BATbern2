...
describeIntegration('Partner API Integration Tests', () => {
  ...
  describe('AC10.1: Partner API Integration with Story 2.7 Backend', () => {
    it(
      'should_fetchPartnersList_when_backendServiceRunning',
      async () => {
        // Arrange
    ...
    it(
      'should_returnPaginatedResults_when_multiplePagesExist',
      async () => {
        // Arrange
        const filters: PartnerFilters = { tier: 'all', status: 'all' };
        const sort: PartnerSort = { sortBy: 'name', sortOrder: 'asc' };
    ...
    it(
      'should_filterByTier_when_tierFilterApplied',
      async () => {
        // Arrange
    ...
    it(
      'should_filterByActiveStatus_when_statusFilterApplied',
      async () => {
        // Arrange
    ...
    it(
      'should_sortByName_when_sortParameterSet',
      async () => {
        // Arrange
        const filters: PartnerFilters = { tier: 'all', status: 'all' };
  ...
  describe('AC10.2: HTTP Enrichment - Company Data Integration', () => {
    it(
      'should_includeCompanyData_when_includeCompanyParameterUsed',
      async () => {
        // Arrange
        const filters: PartnerFilters = { tier: 'all', status: 'all' };
        const sort: PartnerSort = { sortBy: 'name', sortOrder: 'asc' };
    ...
    it(
      'should_handleMissingCompanyData_when_companyNotFound',
      async () => {
        // Arrange
        const filters: PartnerFilters = { tier: 'all', status: 'all' };
        const sort: PartnerSort = { sortBy: 'name', sortOrder: 'asc' };
  ...
  describe('AC10.3: HTTP Enrichment - Contact Data Integration', () => {
    it(
      'should_includeContactData_when_includeContactsParameterUsed',
      async () => {
        // Arrange
        const filters: PartnerFilters = { tier: 'all', status: 'all' };
        const sort: PartnerSort = { sortBy: 'name', sortOrder: 'asc' };
    ...
    it(
      'should_identifyPrimaryContact_when_multipleContactsExist',
      async () => {
        // Arrange
        const filters: PartnerFilters = { tier: 'all', status: 'all' };
        const sort: PartnerSort = { sortBy: 'name', sortOrder: 'asc' };
    ...
    it(
      'should_handleMissingContactData_when_contactsNotFound',
      async () => {
        // Arrange
        const filters: PartnerFilters = { tier: 'all', status: 'all' };
        const sort: PartnerSort = { sortBy: 'name', sortOrder: 'asc' };
  ...
  describe('AC10.4: Error Handling', () => {
    it(
      'should_return404_when_invalidEndpointCalled',
      async () => {
        // Arrange
    ...
    it(
      'should_returnErrorResponse_when_invalidPageNumber',
      async () => {
        // Arrange
        const filters: PartnerFilters = { tier: 'all', status: 'all' };
        const sort: PartnerSort = { sortBy: 'name', sortOrder: 'asc' };
    ...
    it(
      'should_returnErrorResponse_when_invalidFilterValue',
      async () => {
        // Arrange
        ...
        // Act & Assert
        await expect(listPartners(filters, sort, pagination)).rejects.toThrow();
      },
      TEST_TIMEOUT
    );

    it(
      'should_handleNetworkTimeout_when_backendSlow',
      async () => {
        ...
        // Act & Assert
        await expect(axiosWithTimeout.get('/partners')).rejects.toThrow();
      },
      TEST_TIMEOUT
    );
  });
  ...
  describe('AC10.5: JWT Token Propagation', () => {
    it(
      'should_return401_when_noJWTTokenProvided',
      async () => {
        // Arrange
        ...
        // Act & Assert
        await expect(axiosWithoutAuth.get('/partners')).rejects.toThrow();
      },
      TEST_TIMEOUT
    );

    it(
      'should_return401_when_invalidJWTTokenProvided',
      async () => {
        // Arrange
        ...
        // Act & Assert
        await expect(axiosWithInvalidAuth.get('/partners')).rejects.toThrow();
      },
      TEST_TIMEOUT
    );

    it(
      'should_propagateJWT_when_validTokenProvided',
      async () => {
        // Arrange
        const filters: PartnerFilters = { tier: 'all', status: 'all' };
        const sort: PartnerSort = { sortBy: 'name', sortOrder: 'asc' };
  ...
  describe('Partner Statistics API Integration', () => {
    it(
      'should_fetchStatistics_when_statisticsEndpointCalled',
      async () => {
        // Act
    ...
    it(
      'should_matchListCount_when_comparingStatisticsToList',
      async () => {
        // Arrange
        const filters: PartnerFilters = { tier: 'all', status: 'all' };
        const sort: PartnerSort = { sortBy: 'name', sortOrder: 'asc' };
