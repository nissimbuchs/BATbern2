...
export interface paths {
  '/users/{username}/watch-pairing': {
    ...
    /**
     * Get pairing status
     * @description Returns list of paired watches and any pending pairing code.
     */
    get: operations['getWatchPairingStatus'];
    put?: never;
    /**
     * Generate pairing code (AC1)
     * @description Generate a 6-digit numeric pairing code for the organizer's Apple Watch.
     *     Code expires after 24 hours (NFR20). Max 2 watches per organizer (NFR19).
     */
    post: operations['generateWatchPairingCode'];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  '/users/{username}/watch-pairing/{watchId}': {
    parameters: {
      query?: never;
      header?: never;
      path?: never;
    ...
    /**
     * Unpair a watch (AC4)
     * @description Hard-delete the pairing record by UUID (GDPR compliant). Uses id instead of deviceName because deviceName is nullable (not set during pairing flow).
     */
    delete: operations['unpairWatch'];
    options?: never;
    head?: never;
    patch?: never;
    trace?: never;
  ...
  '/watch/pair': {
    ...
    put?: never;
    /**
     * Exchange pairing code for pairing token (W2.2 AC2/AC3)
     * @description Exchanges a 6-digit pairing code (generated via POST /users/{username}/watch-pairing)
     *     for a long-lived pairing token. The code is single-use and cleared after exchange.
     *
     *     **Unauthenticated** — the pairing code is the credential.
     *
     *     Returns 400 if code is invalid, not found, or expired.
     */
    post: operations['pairWatch'];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
  ...
  '/watch/authenticate': {
    ...
    put?: never;
    /**
     * Exchange pairing token for short-lived JWT (W2.2 AC4/NFR16)
     * @description Exchanges a pairing token for a short-lived JWT (1-hour lifespan per NFR16).
     *     Called on app launch and auto-refreshed 10 minutes before expiry.
     *
     *     **Unauthenticated** — the pairing token is the credential.
     *
     *     Returns 401 if pairing token is invalid or pairing is incomplete.
     */
    post: operations['authenticateWatch'];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
...
export interface components {
  schemas: {
    ...
    WatchPairingResponse: {
      /** @description Long-lived token stored in Watch Keychain (NFR15) */
      pairingToken: string;
      /** @description Organizer's username */
      organizerUsername: string;
      /** @description Organizer's first name for display */
      organizerFirstName: string;
    };
    WatchAuthRequest: {
      /** @description Pairing token obtained from /watch/pair */
      pairingToken: string;
    };
    WatchAuthResponse: {
      /** @description Short-lived JWT for authenticated Watch API calls (1 hour, NFR16) */
      jwt: string;
      /**
       * Format: date-time
       * @description JWT expiry timestamp (ISO 8601)
       */
      expiresAt: string;
    };
    /**
    ...
    PairingStatusResponse: {
      pairedWatches?: components['schemas']['PairedWatch'][];
      pendingCode?: components['schemas']['PendingPairingCode'] | null;
    };
    PairedWatch: {
      /**
       * Format: uuid
       * @description Stable UUID identifier used for unpair. Never null.
       */
      id: string;
      /** @description Device name, nullable (not set during pairing flow). */
...
export interface operations {
  ...
  generateWatchPairingCode: {
    ...
    responses: {
      ...
      /** @description Forbidden - not owner or not ORGANIZER role */
      403: {
        headers: {
          [name: string]: unknown;
        };
      ...
      /** @description Maximum 2 watches already paired (AC2) */
      409: {
        headers: {
          [name: string]: unknown;
        };
  ...
  pairWatch: {
    ...
    requestBody: {
      content: {
         ...
         *     }
         */
        'application/json': components['schemas']['WatchPairingRequest'];
      };
    };
    responses: {
      /** @description Pairing successful — returns pairing token and organizer details */
      200: {
        headers: {
          [name: string]: unknown;
        };
        content: {
          /**
           * @example {
           *       "pairingToken": "a1b2c3d4-1234567890-98765",
           *       "organizerUsername": "marco.organizer",
           *       "organizerFirstName": "Marco"
           *     }
           */
          'application/json': components['schemas']['WatchPairingResponse'];
        };
      };
      /** @description Code invalid, expired, or wrong format */
      400: {
        headers: {
          [name: string]: unknown;
        };
  ...
  authenticateWatch: {
    ...
    requestBody: {
      content: {
         ...
         *     }
         */
        'application/json': components['schemas']['WatchAuthRequest'];
      };
    };
    responses: {
      /** @description Authentication successful — returns JWT and expiry */
      200: {
        headers: {
          [name: string]: unknown;
        };
        content: {
           ...
           *       "expiresAt": "2026-02-17T16:30:00"
           *     }
           */
          'application/json': components['schemas']['WatchAuthResponse'];
        };
      };
      /** @description Pairing token invalid or pairing incomplete */
      401: {
        headers: {
          [name: string]: unknown;
        };
