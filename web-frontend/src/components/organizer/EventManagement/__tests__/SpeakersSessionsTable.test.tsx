...
const mockSessions: Session[] = [
  ...
  },
  {
    ...
    materialsStatus: 'missing' as const,
  },
...
describe('SpeakersSessionsTable Component (AC8: Speakers & Sessions Display)', () => {
  ...
  describe('Footer Action Buttons (Test 8.9-8.11: AC8 - Footer buttons)', () => {
    ...
    it('should_callOnViewFullAgenda_when_clicked', async () => {
      ...
      const button = screen.getByRole('button', { name: /view full agenda/i });
    ...
    it('should_showManageSpeakerAssignmentsButton_when_rendered', () => {
      ...
      expect(
        screen.getByRole('button', { name: /manage speaker assignments/i })
      ).toBeInTheDocument();
    });
    ...
    it('should_callOnManageSpeakerAssignments_when_clicked', async () => {
      ...
      const button = screen.getByRole('button', { name: /manage speaker assignments/i });
      await user.click(button);
    ...
    it('should_callOnAutoAssignSpeakers_when_clicked', async () => {
      ...
      const buttons = screen.getAllByRole('button', { name: /auto-assign speakers/i });
    ...
    it('should_showConfirmationDialog_when_autoAssignClicked', async () => {
      ...
      const autoAssignTexts = screen.getAllByText(/auto-assign speakers/i);
      expect(autoAssignTexts.length).toBeGreaterThanOrEqual(2); // Button + Dialog title
      expect(screen.getByText(/this will automatically assign speakers/i)).toBeInTheDocument();
    });
  });
