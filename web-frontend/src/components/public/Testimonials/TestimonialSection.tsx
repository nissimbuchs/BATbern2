...
const testimonials: Testimonial[] = [
  {
    id: '1',
    name: 'Andreas Müller',
    quote: 'BATbern events are always insightful and well-organized. A must-attend for any architect in the region.',
    company: 'Swisscom AG'
  },
  {
    id: '2',
    name: 'Sarah Schmidt',
    quote: 'The networking opportunities at BATbern are unmatched. I always leave with new connections and ideas.',
    company: 'Die Schweizerische Post'
  },
  {
    id: '3',
    name: 'Thomas Weber',
    quote: 'Excellent speakers and cutting-edge topics. BATbern keeps us at the forefront of architectural innovation.',
    company: 'BLS AG'
  },
  {
    id: '4',
  ...
  },
  {
    id: '7',
    name: 'Daniel Fischer',
    quote: 'I appreciate how BATbern brings together architects from different specializations and backgrounds.',
  ...
  },
  {
    id: '10',
    name: 'Anna Koch',
    quote: 'The atmosphere is professional yet welcoming. Perfect for both learning and networking.',
    company: 'Inselspital Bern'
  },
  {
    id: '11',
    name: 'Stefan Bauer',
    quote: 'Outstanding organization and speaker selection. BATbern sets the standard for professional events.',
