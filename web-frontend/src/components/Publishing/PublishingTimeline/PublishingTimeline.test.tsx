...
describe('PublishingTimeline', () => {
  ...
  describe('Responsive Design', () => {
    it('should render horizontal timeline on desktop', () => {
      ...
      expect(timeline).toHaveClass(/horizontal/i);
    });

    it('should render vertical timeline on mobile', () => {
      ...
      const timeline = screen.getByTestId('publishing-timeline');
      expect(timeline).toHaveClass(/vertical/i);
    });
  });
  ...
  describe('Accessibility', () => {
    it('should have accessible labels for phase nodes', () => {
      ...
      expect(screen.getByLabelText(/topic phase - published/i)).toBeInTheDocument();
      expect(screen.getByLabelText(/speakers phase - published/i)).toBeInTheDocument();
      expect(screen.getByLabelText(/agenda phase - pending/i)).toBeInTheDocument();
    });

    it('should announce current phase to screen readers', () => {
      render(
        <PublishingTimeline
          eventCode="BATbern142"
          currentPhase="speakers"
      ...
      expect(announcement).toHaveTextContent(/currently on speakers phase/i);
    });
  });
});
