...
struct ComplicationProvider: TimelineProvider {
    ...
    func getSnapshot(in context: Context, completion: @escaping (ComplicationEntry) -> Void) {
        let resolved = ComplicationDataStore.resolvedSnapshot(ComplicationDataStore.read())
...
// Staleness logic lives in ComplicationDataStore.resolvedSnapshot(_:now:) — shared with tests.
