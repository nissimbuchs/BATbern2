...
> the heaviest) DONE on branch `e2e-admin-tabs` (off develop post-#700; awaiting push/merge) —
> green ×2 vs dev = 14/14, residue-free. Render `@gate` for all 9 tabs + 2 pages
