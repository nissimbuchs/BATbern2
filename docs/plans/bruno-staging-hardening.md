...
| 2b | `test-enhancement/bruno-event-full-workflow-api-tests` | Net-new event-full-workflow-api tests: advance through 8 workflow states + registrations CRUD | ⬜ not started — gated on PR 2 | — | Directory seeded with 12/13/16 + 13a.disabled by PR 2. The 8-state advancement is its own design problem (state-machine ordering, valid/invalid transition matrix). |
