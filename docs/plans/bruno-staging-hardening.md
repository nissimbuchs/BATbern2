...
| 2a | `test-enhancement/bruno-event-types-api-tests` | Net-new event-types-api tests: GET /event-types + idempotent PUT + document API gap (no POST/DELETE) | ⬜ not started — gated on PR 2 | — | Stub directory + README created by PR 2. ~3-5 tests. |
