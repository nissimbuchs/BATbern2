...
| TimetableResponse (+TimetableSlot) | ⏳ TODO — **next/last in chain** | twin (sessions), embeds SessionResponse+TimetableSlot. SessionResponse now consolidated, so unblocked. |
