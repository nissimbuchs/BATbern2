...
>   `/admin/sync-status`) — the deferred UI gate is now satisfied. ⏳ **Next:** remaining CUMS controllers (UserPreferences /
>   UserSettings / PublicOrganizer / Logo — the last two undocumented → spec-first), then EMS (4/45).
