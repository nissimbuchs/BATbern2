# Story 1.15a.9: Attendees API Consolidation

**Linear Issue**: [BAT-10](https://linear.app/batbern/issue/BAT-10/attendees-api-consolidation)
...
- Caffeine (in-memory recommendation caching)
