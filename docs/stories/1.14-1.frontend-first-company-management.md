...
**Frontend-First Focus:** This story defines the API contract inline and implements the complete UI/UX for company management with MSW mocks. Backend implementation follows in Story 1.14-2.
