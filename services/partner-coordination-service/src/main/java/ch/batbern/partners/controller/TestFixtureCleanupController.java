...
import ch.batbern.partners.service.TestFixtureCleanupService;
...
/**
 * Bruno test-fixture cleanup endpoint for PCS.
 *
 ...
 * accumulated leftovers don't pollute the production-account DB. Staging audit
 ...
 *   <li>Prefix must match the server-side regex bound to the entity type</li>
