...
/**
 * Speaker self-service content submission via the speaker portal.
 ...
 * uploaded presentation in a single submit.
 *
 * <p>Story 11.E.3: {@code token} field removed — the portal is now Cognito-secured and the
 * {@code eventCode} arrives as a path parameter.
 *
