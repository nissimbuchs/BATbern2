...
/**
 * Domain Event: SpeakerUpdated
 * Published when a speaker profile is updated.
 *
...
public class SpeakerUpdatedEvent extends DomainEvent<UUID> {
    ...
    private final List<String> changedFields; // Fields that were modified

    public SpeakerUpdatedEvent(
        ...
        super(speakerId, "SpeakerUpdated", triggeredByUsername);
