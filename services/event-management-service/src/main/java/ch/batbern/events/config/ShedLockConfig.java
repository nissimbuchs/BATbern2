 ...
 * causing duplicate state transitions, duplicate emails, and race conditions.
 *
 * How it works:
 ...
 *
 * Database table: shedlock (created by V31__Add_shedlock_table.sql)
 *
 * Production scenario:
...
public class ShedLockConfig {
     ...
     * Each scheduled job has a unique lock name (e.g., "eventWorkflowScheduledTask")
     *
