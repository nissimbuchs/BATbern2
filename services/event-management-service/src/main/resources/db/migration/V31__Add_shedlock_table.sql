-- V31: Add ShedLock table for distributed scheduled task locking
...
COMMENT ON TABLE shedlock IS 'ShedLock distributed lock table for scheduled tasks (GAP-2)';
COMMENT ON COLUMN shedlock.name IS 'Unique job identifier (e.g., eventWorkflowScheduledTask)';
