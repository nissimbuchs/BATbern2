...
public class AnonymousRegistrationE2EIntegrationTest extends AbstractIntegrationTest {
    ...
    void setUp() {
        ...
        testEvent = Event.builder()
                ...
                .eventNumber(142)
                .date(Instant.parse("2027-06-15T09:00:00Z"))
                .registrationDeadline(Instant.parse("2027-06-08T23:59:59Z"))
    ...
    void should_returnExistingAnonymousUser_when_sameEmailRegistersAgain() throws Exception {
        ...
        Event secondEvent = Event.builder()
                ...
                .eventNumber(143)
                .date(Instant.parse("2027-07-15T09:00:00Z"))
                .registrationDeadline(Instant.parse("2027-07-08T23:59:59Z"))
                .venueName("Test Venue")
